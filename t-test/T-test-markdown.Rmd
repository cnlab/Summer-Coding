...
```{r}
setwd("/Users/stevenmesquiti/Desktop/Summer Coding Curriculum/Summer-Coding/t-test") #change to your own WD. you can do that buy modifying the file path or go session (on the upper bar) --> set working directory)
...
analyses. For the first oart we are going to be looking at gender differences between
