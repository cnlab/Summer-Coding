---
title: "Simple Correlation examples "
author: "Steven"
date: "`r Sys.Date()`"
output:
  html_document:
...
variables in our dataset). We can see that variables R is treating as continuos and move forward with our analyses! 
...
**Flesch-Kincaid Ease of Readability**: higher scores indicate material that is easier to read; lower numbers mark passages that are more difficult to read. Calculated using `spacCy` in python.

**The Flesch–Kincaid Grade Level Score**: presents a score as a U.S. grade level, making it easier for teachers, parents, librarians, and others to judge the readability level of various books and texts.Calculated using `spacCy` in python.
